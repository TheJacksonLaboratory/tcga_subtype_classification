import Config
import DataRna as Data #data process different from 254 version in Helpers
...
scan_object = ta.Restore('resnet_tumor_type_t_'+Config.treat+'.zip')
...
train_x_all = np.reshape(train_x_all, (train_x_all.shape[0], 32, -1))

train_x_all = np.expand_dims(train_x_all, axis=3)
